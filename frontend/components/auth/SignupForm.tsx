...
export default function SignupForm({ redirectTo = '/connect' }: SignupFormProps) {
    ...
    return (
        <div className="max-w-md w-full space-y-8 bg-[var(--color-card-dark)] p-10 rounded-2xl shadow-2xl border border-[var(--color-card-border)] relative overflow-hidden z-20">
            {/* Decorative elements */}
            ...
            <form className="mt-8 space-y-6 relative" onSubmit={handleRegister}>
                ...
                <div className="relative mt-6 mb-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-[var(--color-card-dark)] text-[var(--color-text-muted)] rounded-md">Or continue with</span>
                    </div>
                </div>
